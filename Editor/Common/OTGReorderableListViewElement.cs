...
{
    public class OTGReorderableListViewElement : VisualElement
    {
        ...
        public new class UxmlFactory : UxmlFactory<OTGReorderableListViewElement>
        {
        ...
        public OTGReorderableListViewElement()
        {
            m_ownerObject = null;
            m_items = null;
        }
        public OTGReorderableListViewElement(SerializedObject _owner, SerializedProperty _items, string _listName)
        {
